        ...
        <div className="layout-container grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/works">
                <Button className="gap-2 bg-primary hover:bg-primary/90 shadow-md hover:shadow-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-white dark:bg-secondary/40 border border-primary/10 p-6 rounded-xl shadow-md hover:shadow-xl card-hover"
              >
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="layout-container">
          ...
          >
            ...
            <Link to="/contact">
              <Button size="lg" className="gap-2 bg-primary hover:bg-primary/90 shadow-md hover:shadow-lg">
